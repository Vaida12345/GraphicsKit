...
public extension FinderItem.AsyncLoadableContent where Result == NativeImage {
    ...
    private static func renderIconStyle(cgImage: CGImage) async -> CGImage? {
        ...
        let context = CGContext.createContext(size: contextSize, bitsPerComponent: cgImage.bitsPerComponent, space: cgImage.colorSpace ?? CGColorSpaceCreateDeviceRGB(), withAlpha: true)
